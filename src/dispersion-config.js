...
export const DISPERSION_DEFAULTS = Object.freeze({
  ...
  causticScale: 1.0,
  causticHueShift: 0.0,
  fractalBloomGain: 0.0,
  fractalBloomDecay: 0.6,
  fractalBloomRadius: 0.4,
});
...
export const DISPERSION_PARAM_SCHEMA = [
  ...
  { key: 'causticMix', label: 'Caustic Mix', section: 'color', type: 'range', min: 0.0, max: 2.0, step: 0.02, fineStep: 0.005, default: DISPERSION_DEFAULTS.causticMix, keywords: ['caustic', 'veil', 'treble'] },
  { key: 'causticScale', label: 'Caustic Scale', section: 'color', type: 'range', min: 0.2, max: 5.0, step: 0.05, fineStep: 0.01, default: DISPERSION_DEFAULTS.causticScale, keywords: ['caustic', 'pattern', 'scale'] },
  { key: 'causticHueShift', label: 'Caustic Hue Shift', section: 'color', type: 'range', min: -3.1416, max: 3.1416, step: 0.05, fineStep: 0.01, default: DISPERSION_DEFAULTS.causticHueShift, keywords: ['caustic', 'color', 'hue'] },
  { key: 'prismIntensity', label: 'Prism Intensity', section: 'color', type: 'range', min: 0.0, max: 2.5, step: 0.05, fineStep: 0.01, default: DISPERSION_DEFAULTS.prismIntensity, keywords: ['prism', 'chroma', 'breath'] },
  { key: 'prismSlices', label: 'Prism Slices', section: 'color', type: 'range', min: 2, max: 12, step: 1, fineStep: 1, default: DISPERSION_DEFAULTS.prismSlices, keywords: ['prism', 'slices'] },
  { key: 'prismBreath', label: 'Prism Breath', section: 'color', type: 'range', min: 0.0, max: 2.0, step: 0.02, fineStep: 0.005, default: DISPERSION_DEFAULTS.prismBreath, keywords: ['prism', 'breathing'] },
  ...
  { key: 'fractalBloomGain', label: 'Fractal Bloom Gain', section: 'tone', type: 'range', min: 0.0, max: 3.0, step: 0.05, fineStep: 0.01, default: DISPERSION_DEFAULTS.fractalBloomGain, keywords: ['bloom', 'downbeat', 'fractal'] },
  { key: 'fractalBloomDecay', label: 'Fractal Bloom Decay', section: 'tone', type: 'range', min: 0.1, max: 2.5, step: 0.05, fineStep: 0.01, default: DISPERSION_DEFAULTS.fractalBloomDecay, keywords: ['bloom', 'decay'] },
  { key: 'fractalBloomRadius', label: 'Fractal Bloom Radius', section: 'tone', type: 'range', min: 0.1, max: 1.2, step: 0.02, fineStep: 0.005, default: DISPERSION_DEFAULTS.fractalBloomRadius, keywords: ['bloom', 'radius'] },
  ...
  { key: 'autoStutterMode', label: '🤖 Auto-Adjust Window', section: 'stutter', type: 'boolean', default: DISPERSION_DEFAULTS.autoStutterMode, keywords: ['stutter', 'auto', 'adaptive'] },
  ...
  { key: 'autoPulseDecay', label: '🤖 Auto Pulse Decay', section: 'stutter', type: 'boolean', default: DISPERSION_DEFAULTS.autoPulseDecay, keywords: ['pulse', 'auto', 'decay'] },
  { key: 'flipRiseMs', label: 'Flip Rise (ms)', section: 'stutter', type: 'range', min: 10, max: 4000, step: 10, fineStep: 5, default: DISPERSION_DEFAULTS.flipRiseMs, keywords: ['flip', 'rise', 'smooth'] },
  { key: 'flipFallMs', label: 'Flip Fall (ms)', section: 'stutter', type: 'range', min: 10, max: 4000, step: 10, fineStep: 5, default: DISPERSION_DEFAULTS.flipFallMs, keywords: ['flip', 'fall', 'smooth'] },
  { key: 'flipHoldBeats', label: 'Flip Hold (beats)', section: 'stutter', type: 'range', min: 0, max: 16, step: 1, fineStep: 1, default: DISPERSION_DEFAULTS.flipHoldBeats, keywords: ['flip', 'hold', 'beats'] },
  { key: 'flipAmount', label: 'Flip Amount', section: 'stutter', type: 'range', min: 0.0, max: 1.0, step: 0.01, fineStep: 0.002, default: DISPERSION_DEFAULTS.flipAmount, keywords: ['flip', 'amount', 'mix'] },
  ...
  { key: 'rippleGain', label: 'Ripple Gain', section: 'travel', type: 'range', min: 0.0, max: 3.0, step: 0.05, fineStep: 0.01, default: DISPERSION_DEFAULTS.rippleGain, keywords: ['ripple', 'flux', 'motion'] },
  { key: 'rippleSpeed', label: 'Ripple Speed', section: 'travel', type: 'range', min: 0.1, max: 6.0, step: 0.05, fineStep: 0.01, default: DISPERSION_DEFAULTS.rippleSpeed, keywords: ['ripple', 'speed'] },
  { key: 'rippleDensity', label: 'Ripple Density', section: 'travel', type: 'range', min: 0.5, max: 12.0, step: 0.1, fineStep: 0.02, default: DISPERSION_DEFAULTS.rippleDensity, keywords: ['ripple', 'density'] },
  ...
  { key: 'shockRibGain', label: 'Shock Rib Gain', section: 'drill', type: 'range', min: 0.0, max: 2.5, step: 0.05, fineStep: 0.01, default: DISPERSION_DEFAULTS.shockRibGain, keywords: ['shock', 'rib', 'bass', 'pulse'] },
  { key: 'shockRibDecay', label: 'Shock Rib Decay', section: 'drill', type: 'range', min: 0.1, max: 2.5, step: 0.05, fineStep: 0.01, default: DISPERSION_DEFAULTS.shockRibDecay, keywords: ['shock', 'rib', 'decay'] },
  { key: 'shockRibWidth', label: 'Shock Rib Width', section: 'drill', type: 'range', min: 0.05, max: 1.5, step: 0.01, fineStep: 0.005, default: DISPERSION_DEFAULTS.shockRibWidth, keywords: ['shock', 'rib', 'width'] },
];
